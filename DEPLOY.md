...
Only when the most recent deployment shows as active, and a genuinely fresh request still gives you a web page, is it worth suspecting the routing rules themselves. This is rarer than it sounds, so do not start here.
